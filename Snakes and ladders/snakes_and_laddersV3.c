...
int my_move(int *player_move, int *user_move)
{
    int move;
...
void print_board(int *player_move, int *opp_move, int *up1, int *up2, int *up3, int *up4, int *up5, int *up6, int *down1, int *down2, int *down3, int *down4, int *down5, int *down6) 
{
        ...
        if (toupper(choice2) == 'Y') {
            while (player_move < 99 && opp_move < 99) {
                ...
                if(toupper(choice3) == 'Y') {
                    my_move(&player_move, &user_move);
                    cpu_move(&opp_move, &pc_move);
                    print_board(&player_move, &opp_move, &up1, &up2, &up3, &up4, &up5, &up6, &down1, &down2, &down3, &down4, &down5, &down6);
                    printf("\033[0m");
